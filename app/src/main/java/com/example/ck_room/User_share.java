...
public class User_share extends AppCompatActivity
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        share = findViewById(R.id.butSend);
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(User_share.this, "Send success", Toast.LENGTH_SHORT).show();
    ...
    private void sendSMS(String phoneNumber,String message) {
        ...
        if (ContextCompat.checkSelfPermission(User_share.this, android.Manifest.permission.SEND_SMS) == PackageManager.PERMISSION_GRANTED) {
            startActivityForResult(intent, 100000000);
        } else {
            ActivityCompat.requestPermissions(User_share.this, new String[]{Manifest.permission.SEND_SMS}, REQUEST_SEND_SMS_PERMISSION);
        }
    }
