        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == radioEco.getId()) {
                    ...
                    adapter3 = new CustomAdapter_user_seat(itemList,check,User_choose_seat.this, price,seat,finalT_c.getBusiness_Fare());
                    recyclerView.setAdapter(adapter3);
                } else if (checkedId == radioFirst.getId())
                {
                    ...
                    adapter3 = new CustomAdapter_user_seat(itemList,check,User_choose_seat.this, price,seat,finalT_c.getFirst_Fare());
                    recyclerView.setAdapter(adapter3);
                }
