...
public final class AdminEditStationBinding implements ViewBinding {
  @NonNull
  ...
  private AdminEditStationBinding(@NonNull ConstraintLayout rootView, @NonNull LinearLayout addGr,
      @NonNull Button btBack, @NonNull Button btCreate, @NonNull CardView cardView5,
      @NonNull EditText edtAddress, @NonNull EditText edtName, @NonNull View form4,
  ...
  @NonNull
  public static AdminEditStationBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdminEditStationBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.admin_edit_station, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdminEditStationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.form4;
      View form4 = ViewBindings.findChildViewById(rootView, id);
      if (form4 == null) {
        break missingId;
      }
      ...
      return new AdminEditStationBinding((ConstraintLayout) rootView, addGr, btBack, btCreate,
          cardView5, edtAddress, edtName, form4, imageView4, lnLogout, nameGr, title, txtAdd,
          txtName, view);
    }
