...
public final class AdminViewUserBinding implements ViewBinding {
  @NonNull
  ...
  private AdminViewUserBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextView txtPhone, @NonNull View view, @NonNull View view2) {
  ...
  @NonNull
  public static AdminViewUserBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdminViewUserBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.admin_view_user, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdminViewUserBinding bind(@NonNull View rootView) {
