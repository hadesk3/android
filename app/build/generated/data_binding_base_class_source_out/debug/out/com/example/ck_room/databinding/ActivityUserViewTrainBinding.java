...
public final class ActivityUserViewTrainBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityUserViewTrainBinding(@NonNull ConstraintLayout rootView,
      @NonNull LinearLayout DepartGr, @NonNull LinearLayout arrGr, @NonNull CardView bt,
      @NonNull Button btBack, @NonNull Button btBook, @NonNull CardView cardView5,
      @NonNull LinearLayout dateGr, @NonNull TextView edtArrive, @NonNull TextView edtBusFare,
      @NonNull TextView edtBusPass, @NonNull TextView edtDate, @NonNull TextView edtDepart,
      @NonNull TextView edtEcoFare, @NonNull TextView edtEcoPass, @NonNull TextView edtEnd,
      @NonNull TextView edtFirstFare, @NonNull TextView edtFirstPass, @NonNull TextView edtName,
  ...
  @NonNull
  public static ActivityUserViewTrainBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityUserViewTrainBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_user_view_train, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityUserViewTrainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btBook;
      Button btBook = ViewBindings.findChildViewById(rootView, id);
      if (btBook == null) {
        break missingId;
      }
      ...
      return new ActivityUserViewTrainBinding((ConstraintLayout) rootView, DepartGr, arrGr, bt,
          btBack, btBook, cardView5, dateGr, edtArrive, edtBusFare, edtBusPass, edtDate, edtDepart,
