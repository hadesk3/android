...
public final class UserShareMailBinding implements ViewBinding {
  @NonNull
  ...
  private UserShareMailBinding(@NonNull LinearLayout rootView, @NonNull Button btBack,
  ...
  @NonNull
  public static UserShareMailBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static UserShareMailBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.user_share_mail, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static UserShareMailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new UserShareMailBinding((LinearLayout) rootView, btBack, butSend, phone, textView42,
          view28, view29);
    }
