...
public final class UserSearchBinding implements ViewBinding {
  ...
  private UserSearchBinding(@NonNull ConstraintLayout rootView, @NonNull LinearLayout DepartGr,
  ...
  public static UserSearchBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new UserSearchBinding((ConstraintLayout) rootView, DepartGr, arrGr, bt, btBack,
          btSearch, cardView5, dateGr, edtArrive, edtDate, edtDepart, form, form2, imageView4,
          recyclerViewmanage, title, txtArrive, txtDate, txtDepart, view);
    }
