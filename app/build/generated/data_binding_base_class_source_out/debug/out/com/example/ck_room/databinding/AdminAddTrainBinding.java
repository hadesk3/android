...
public final class AdminAddTrainBinding implements ViewBinding {
  @NonNull
  ...
  private AdminAddTrainBinding(@NonNull ConstraintLayout rootView, @NonNull LinearLayout DepartGr,
      @NonNull LinearLayout arrGr, @NonNull Button btBack, @NonNull Button btCreate,
      @NonNull CardView cardView5, @NonNull LinearLayout dateGr, @NonNull Spinner edtArrive,
      @NonNull EditText edtBusFare, @NonNull EditText edtBusPass, @NonNull TextView edtDate,
      @NonNull Spinner edtDepart, @NonNull EditText edtEcoFare, @NonNull EditText edtEcoPass,
  ...
  @NonNull
  public static AdminAddTrainBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdminAddTrainBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.admin_add_train, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdminAddTrainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdminAddTrainBinding((ConstraintLayout) rootView, DepartGr, arrGr, btBack,
          btCreate, cardView5, dateGr, edtArrive, edtBusFare, edtBusPass, edtDate, edtDepart,
