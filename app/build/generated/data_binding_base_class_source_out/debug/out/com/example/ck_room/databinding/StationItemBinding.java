...
public final class StationItemBinding implements ViewBinding {
  ...
  @NonNull
  public static StationItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static StationItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.station_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static StationItemBinding bind(@NonNull View rootView) {
