...
public final class ItemStationBinding implements ViewBinding {
  ...
  private ItemStationBinding(@NonNull LinearLayout rootView, @NonNull TextView txtLocation,
  ...
  public static ItemStationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemStationBinding((LinearLayout) rootView, txtLocation, txtName);
    }
