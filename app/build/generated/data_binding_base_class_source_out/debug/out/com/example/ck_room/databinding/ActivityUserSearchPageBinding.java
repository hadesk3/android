...
public final class ActivityUserSearchPageBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityUserSearchPageBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull LinearLayout dateGr, @NonNull Spinner edtArrive, @NonNull TextView edtDate,
      @NonNull Spinner edtDepart, @NonNull View form, @NonNull View form2,
      ...
      @NonNull TextView txtDepart, @NonNull View view) {
  ...
  @NonNull
  public static ActivityUserSearchPageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityUserSearchPageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_user_search_page, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityUserSearchPageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityUserSearchPageBinding((ConstraintLayout) rootView, DepartGr, arrGr, bt,
          btBack, btSearch, cardView5, dateGr, edtArrive, edtDate, edtDepart, form, form2,
          imageView4, recyclerViewmanage, title, txtArrive, txtDate, txtDepart, view);
    }
