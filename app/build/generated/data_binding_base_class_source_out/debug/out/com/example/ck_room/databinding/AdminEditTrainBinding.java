...
public final class AdminEditTrainBinding implements ViewBinding {
  @NonNull
  ...
  private AdminEditTrainBinding(@NonNull ConstraintLayout rootView, @NonNull LinearLayout DepartGr,
      @NonNull LinearLayout arrGr, @NonNull Button btBack, @NonNull Button btUpdateTrain,
      @NonNull CardView cardView5, @NonNull LinearLayout dateGr, @NonNull TextView edtArrive,
      @NonNull EditText edtBusFare, @NonNull EditText edtBusPass, @NonNull TextView edtDate,
      @NonNull TextView edtDepart, @NonNull EditText edtEcoFare, @NonNull EditText edtEcoPass,
      @NonNull TextView edtEnd, @NonNull EditText edtFirstFare, @NonNull EditText edtFirstPass,
      @NonNull EditText edtName, @NonNull TextView edtStart, @NonNull View form,
      ...
      @NonNull TextView txtDepart, @NonNull TextView txtName, @NonNull TextView txtTime,
  ...
  @NonNull
  public static AdminEditTrainBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdminEditTrainBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.admin_edit_train, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdminEditTrainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdminEditTrainBinding((ConstraintLayout) rootView, DepartGr, arrGr, btBack,
          ...
          imageView4, lnLogout, nameGr, tableLayout, textView2, timeGr, title, txtArrive, txtDate,
          txtDepart, txtName, txtTime, txtTo, view);
    }
