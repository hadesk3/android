...
public final class EditStationBinding implements ViewBinding {
  @NonNull
  ...
  private EditStationBinding(@NonNull ConstraintLayout rootView, @NonNull LinearLayout addGr,
      ...
      @NonNull View form4, @NonNull ImageView imageView4, @NonNull LinearLayout nameGr,
  ...
  @NonNull
  public static EditStationBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static EditStationBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.edit_station, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static EditStationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new EditStationBinding((ConstraintLayout) rootView, addGr, bt, btBack, btCreate,
          cardView5, edtAddress, edtName, form4, imageView4, nameGr, title, txtAdd, txtName, view);
    }
