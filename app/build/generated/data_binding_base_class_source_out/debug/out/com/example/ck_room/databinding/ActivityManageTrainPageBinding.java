...
public final class ActivityManageTrainPageBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityManageTrainPageBinding(@NonNull ConstraintLayout rootView,
      @NonNull LinearLayout DepartGr, @NonNull LinearLayout arrGr, @NonNull CardView bt,
      @NonNull CardView bt1, @NonNull Button btBack, @NonNull Button btSearch,
      @NonNull CardView cardView5, @NonNull Button create, @NonNull LinearLayout dateGr,
      @NonNull Spinner edtArrive, @NonNull TextView edtDate, @NonNull Spinner edtDepart,
  ...
  @NonNull
  public static ActivityManageTrainPageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityManageTrainPageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_manage_train_page, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityManageTrainPageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityManageTrainPageBinding((ConstraintLayout) rootView, DepartGr, arrGr, bt,
          bt1, btBack, btSearch, cardView5, create, dateGr, edtArrive, edtDate, edtDepart, form,
          form2, imageView4, recyclerViewmanage, title, txtArrive, txtDate, txtDepart, view);
    }
