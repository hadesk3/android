...
public final class AddTrain1Binding implements ViewBinding {
  @NonNull
  ...
  private AddTrain1Binding(@NonNull ConstraintLayout rootView, @NonNull LinearLayout DepartGr,
      ...
      @NonNull TextView edtDate, @NonNull Spinner edtDepart, @NonNull EditText edtEcoFare,
      @NonNull EditText edtEcoPass, @NonNull TextView edtEnd, @NonNull EditText edtFirstFare,
  ...
  @NonNull
  public static AddTrain1Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AddTrain1Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.add_train1, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AddTrain1Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AddTrain1Binding((ConstraintLayout) rootView, DepartGr, arrGr, bt, btBack,
