...
public final class ManageTrainPageBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final CardView btCard1;

  @NonNull
  public final CardView btCard2;
  ...
  private ManageTrainPageBinding(@NonNull ConstraintLayout rootView, @NonNull LinearLayout addGr,
      @NonNull LinearLayout arrGr, @NonNull Button btBack, @NonNull CardView btCard1,
      @NonNull CardView btCard2, @NonNull Button btCreate, @NonNull Button btSearch,
      @NonNull CardView cardView5, @NonNull LinearLayout dateGr, @NonNull Spinner edtArrive,
      @NonNull TextView edtDate, @NonNull Spinner edtEmail, @NonNull View form, @NonNull View form2,
      ...
      @NonNull TextView txtMail, @NonNull View view) {
    this.rootView = rootView;
    this.addGr = addGr;
    this.arrGr = arrGr;
    this.btBack = btBack;
    this.btCard1 = btCard1;
    this.btCard2 = btCard2;
  ...
  @NonNull
  public static ManageTrainPageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ManageTrainPageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.manage_train_page, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ManageTrainPageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btCard1;
      CardView btCard1 = ViewBindings.findChildViewById(rootView, id);
      if (btCard1 == null) {
        break missingId;
      }

      id = R.id.btCard2;
      CardView btCard2 = ViewBindings.findChildViewById(rootView, id);
      if (btCard2 == null) {
        break missingId;
      }
      ...
      return new ManageTrainPageBinding((ConstraintLayout) rootView, addGr, arrGr, btBack, btCard1,
          btCard2, btCreate, btSearch, cardView5, dateGr, edtArrive, edtDate, edtEmail, form, form2,
          imageView4, recyclerViewmanage, title, txtArrive, txtDate, txtMail, view);
    }
