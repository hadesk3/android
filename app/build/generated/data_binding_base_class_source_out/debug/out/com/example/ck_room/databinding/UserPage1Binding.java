...
public final class UserPage1Binding implements ViewBinding {
  @NonNull
  ...
  private UserPage1Binding(@NonNull ConstraintLayout rootView, @NonNull TextView Tittle,
  ...
  @NonNull
  public static UserPage1Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static UserPage1Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.user_page1, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static UserPage1Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new UserPage1Binding((ConstraintLayout) rootView, Tittle, body, btBooking, btGr,
