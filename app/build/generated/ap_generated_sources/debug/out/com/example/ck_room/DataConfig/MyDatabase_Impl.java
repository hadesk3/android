  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(4) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        ...
        _db.execSQL("CREATE TABLE IF NOT EXISTS `Ticket` (`Ticket_No` TEXT NOT NULL, `Passenger_Name` TEXT, `source` TEXT, `destination` TEXT, `classType` TEXT, `train_id` INTEGER NOT NULL, `date` TEXT, PRIMARY KEY(`Ticket_No`))");
        ...
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'cfe42112ad5a8af16bbefd9ada5c6981')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        final HashMap<String, TableInfo.Column> _columnsTicket = new HashMap<String, TableInfo.Column>(7);
    ...
    }, "cfe42112ad5a8af16bbefd9ada5c6981", "d3cece2ed66e111e18f9c1f3398e8b6d");
