...
public final class TrainDao_Impl implements TrainDao {
  ...
  @Override
  public List<Train> getTrainById(final int id) {
  ...
  @Override
  public List<Train> getTrainByIdAndDay(final int id, final String dayAvailable) {
    final String _sql = "SELECT * FROM Train JOIN Day_available ON Train.train_id = Day_available.train_id WHERE Train.train_id = ? AND Day_available.day_available = ?";
